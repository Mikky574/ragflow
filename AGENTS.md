...
## Commands
For Python source development with Docker-hosted dependencies, follow
[`docs/python-docker-development.zh.md`](docs/python-docker-development.zh.md).
It covers Linux and Windows/WSL setup, API and worker startup, frontend proxy
configuration, local BGE-M3, and verification after OCR changes.
